...
type StreamPlatform = "twitch" | "youtube" | "kick" | "rumble" | "tiktok" | "custom";
...
function normalizeSource(entry: unknown, index: number): StreamSource {
  ...
  const platform = (["twitch", "youtube", "kick", "rumble", "tiktok", "custom"] as const).includes(platformRaw as StreamPlatform)
          ...
          <div className="space-y-5">
            <div className="flex items-center justify-between">
              <p className="text-sm text-zinc-400">
                {tab === "stream"
                  ? "Añade fuentes de Twitch, YouTube, Kick, Rumble, TikTok o URLs personalizadas."
