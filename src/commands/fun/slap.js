...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            const mediaPromise = fetchInteractionGif('slap');
            const countsPromise = incrementMentionCount('slap', interaction.guild?.id || null, user.id).catch(() => ({ total: null, actionCount: null }));
