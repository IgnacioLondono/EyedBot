...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            const mediaPromise = fetchInteractionGif('hug');
            const countsPromise = incrementMentionCount('hug', interaction.guild?.id || null, user.id).catch(() => ({ total: null, actionCount: null }));
