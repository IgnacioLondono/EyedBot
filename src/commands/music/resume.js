...
module.exports = {
    data: new SlashCommandBuilder().setName('resume').setDescription('Reanuda la reproducción actual'),
    cooldown: 2,
    async execute(interaction) {
        ...
        queue.node.resume();
        return interaction.reply({ embeds: [new EmbedBuilder().setColor('#0099FF').setTitle('▶️ Reanudado')] });
    }
};
