...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            if (category) {
                ...
                if (categoryCommands.length === 0) {
                    const categoryMap = {
                        ...
                        utility: ['help', 'ping', 'stats', 'invite', 'translate', 'weather', 'remind', 'urban', 'qrcode', 'color', 'voznombre', 'vozprivado', 'vozinvitar', 'vozquitar'],
            ...
            const utilityCmds = ['help', 'ping', 'stats', 'invite', 'translate', 'weather', 'remind', 'urban', 'qrcode', 'color', 'voznombre', 'vozprivado', 'vozinvitar', 'vozquitar'];
